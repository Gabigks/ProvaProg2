package br.edu.gabriel.controller;
...
import br.edu.gabriel.dao.UsuarioDAO;
import br.edu.gabriel.model.Usuario;
...
public class UsuarioController {
    ...
    public void register() throws Exception {
        try {
        	novoUsuario.setSenha(DigestUtils.sha256Hex(novoUsuario.getSenha()));
